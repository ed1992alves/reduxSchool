...
export const ArtistSearchBar = () => {
    ...
    return(
        <div className="artist-search-bar">
            <input type="text" value={wordEntered} onChange={handleSubmit} placeholder="Search ..." required/>

            <div className="results">
               {filteredData.slice(0,15).map((artist) => {
                     return(
                         <div onClick={() => chooseOption(artist)} className='result-line'>
                                <p>{artist}</p>
                         </div>
